Mobile extensions are a sub-configuration of the extension settings within the UNITADE plugin, specifically activated when Obsidian is used on a mobile device.
