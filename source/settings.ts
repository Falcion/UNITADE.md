...
//         //#endregion
//         //#region Forcing module
//         containerEl.createEl('h3', { text: 'Forced view module' });

//         new Setting(containerEl)
//             .setName('Enable forcing module')
//             .setDesc('Enables module which allows you to control preferences upon opening files by extensions: reading, editing or live preview view modes.')
//             .addToggle(toggle => {
//                 toggle
//                     .setValue(this.plugin.settings.forced_module.enabled)
//                     .onChange(async (value) => {
//                         const next = {
//                             ...this.plugin.settings,
//                             forced_module: {
//                                 ...this.plugin.settings.forced_module,
//                                 enabled: value
//                             }
//                         };
